...
import com.travojet.holiday.adapter.PackageListingAdapter;
import com.travojet.main.activity.MainActivity;
import com.travojet.main.fragment.BaseFragment;
import com.travojet.model.parsingModel.holiday.PackageMainModel;
            ...
            if(jsonObject.getInt("status") == 1){
                ...
                while (i<dataArray.length()){
                    ...
                    packageMainModels.add(new PackageMainModel(
                            ...
                            "http://"+dataObject.getString("image"),
