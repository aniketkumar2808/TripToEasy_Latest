package com.travojet.holiday.fragment;
...
import com.travojet.holiday.adapter.GalleryAdapter;
import com.travojet.holiday.adapter.ItineraryAdapter;
import com.travojet.main.activity.MainActivity;
import com.travojet.main.fragment.BaseFragment;
import com.travojet.model.parsingModel.holiday.ItineraryModel;
            ...
            switch (type){
                case 1:
                    ...
                    price= String.format("%.0f",Double.parseDouble(packageObject.getString("price"))/Double.parseDouble(Global.currencyValue));
                            ...
                            Picasso.get()
                            .load("http://"+packageObject.getString("image"))
                            .into(iv_holiday_bkg);
                    break;
                case 2:
                ...
                case 3:
                    ...
                    while (j < packageImages.length()){
                        ...
                        galleryList.add("http://"+imageObject.getString("traveller_image"));
                        j++;
                    }

                    GalleryAdapter galleryAdapter = new GalleryAdapter(
                            getActivity(), galleryList);
