package com.travojet.traveller;
...
import com.travojet.flight.fragment.FlightSeatFragment;
import com.travojet.main.adapter.PromocodeAdapter;
import com.travojet.main.adapter.WalletTransactionAdapter;
import com.travojet.main.fragment.TicketPreviewFragment;
import com.travojet.model.CountryInfo;
import com.travojet.model.parsingModel.PromoCodeInfo;
import com.travojet.model.parsingModel.WalletModel;
import com.travojet.utils.ProgressLoader;
import com.loopj.android.http.RequestParams;
import com.travojet.R;
import com.travojet.bus.adapter.BusBookingTravellerInfo;
import com.travojet.database.DBAdapter;
import com.travojet.main.fragment.BaseFragment;
import com.travojet.model.parsingModel.TravellerModel;
import com.travojet.model.parsingModel.bus.BusTravellerInfo;
import com.travojet.model.requestModel.bus.confirmSeat.ConfirmSeatMain;
import com.travojet.traveller.adapter.AdultAdapter;
import com.travojet.traveller.adapter.ChildAdapter;
import com.travojet.traveller.adapter.InfantAdapter;
import com.travojet.traveller.interfaces.NotifyTraveller;
...
public class TravellerFragment extends BaseFragment implements NotifyTraveller,
                ...
                if (cb_extraServices.isChecked())
                {
                    ...
                    intentAndFragmentService.fragmentDisplay(getActivity(), R.id.support_frame,
                            new TicketPreviewFragment(fareUpdateResponse,
                                    flightBook.toString(),
                                    params,discountValue, 1), null, true);
                }
        ...
        if (passArray.length() != adultCount + childCount + infantCount) {
            ...
            intentAndFragmentService.fragmentDisplay(getActivity(), R.id.main_frame,
                    new TicketPreviewFragment(hotelResponse,
                            hotelBook.toString(),
                            params,discountValue, 2), null, true);
        }
    }
                        ...
                        if (busTravellerInfos.get(i).getAgeValue() != null &&
                            ...
                            if (i == (seatCountValue - 1)) {
                                ...
                                confirmSeatMains = new ConfirmSeatMain(bus_searchId, gender, paxTitle, contactName,
                                        age, bus_token, bus_ResultToken, "book_bus", "PTBSID0000000003",
                                        mobilePrime.getText().toString(), "", emailPrime.getText().toString(),
                                        "on", "PNHB1");
                                ...
                                try {
                                    ...
                                    jsonObject.put("promo_code_discount_val", discountValue);
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                                String data = jsonObject.toString();
                                RequestParams params = new RequestParams();
                                params.put("confirm_book", data);
                                if (applicationPreference.getData("login_flag").equals("true"))
                                {
                                    params.put("wallet_bal",walletSelectType);
                                } else {
    ...
    public TravellerFragment(String hotelResponse, int adultCount, int childCount,
                             int infantCount, String totalPrice, int i) {
