package com.travojet.bus.adapter;
...
import com.travojet.model.parsingModel.bus.DropOffBean;
...
public class DropAdapter extends ArrayAdapter<DropOffBean> {

    public Context mycontext;
    public List<DropOffBean> objects;


    public DropAdapter(Context context, List<DropOffBean> list)
    {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        DropOffBean deting = objects.get(position);
        if(deting != null){
            holder.titlename.setText(deting.getDropoffName().trim()+" - "+ getHourMin(deting.getDropoffTime()).trim());
            ...
            holder.idtttl.setText(deting.getDropoffCode());
